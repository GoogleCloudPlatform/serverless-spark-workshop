...
* Open the file from the downloaded code repository at `daily-covid-data-analysis/00-scripts/variables.json` and edit the variables as per your environment
...
* Click on **Choose File** and select the file from the downloaded code repository at `daily-covid-data-analysis/00-scripts/variables.json`
