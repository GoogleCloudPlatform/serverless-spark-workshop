...
[4. Create a Cloud Composer Environment](instructions/04-composer.md)
...
- Using [Google Cloud Shell](instructions/05a-daily-covid-data-analysis-gcloud-execution.md)
- Using [GCP console](instructions/05b-daily-covid-data-analysis-console-execution.md )
- Using [Airflow](instructions/05c-daily-covid-data-analysis-airflow-execution.md )
