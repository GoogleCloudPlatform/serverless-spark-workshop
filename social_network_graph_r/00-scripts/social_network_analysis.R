...
unique_node_sparkDF_data <- unique(node_sparkDF_data$Id)

g <- graph_from_data_frame(edge_sparkDF_data, directed=TRUE, vertices=unique_node_sparkDF_data)


deg <- degree(g, mode = "all")
deg <- sort(deg, decreasing = T)[1:30]
print("Degree Result")
deg
