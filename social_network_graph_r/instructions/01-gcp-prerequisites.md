...
[2. Enable Google Dataproc and Google BigQuery APIs](01-gcp-prerequisites.md#2-enable-google-dataproc-and-google-bigquery-apis)<br>
...
## 2. Enable Google Dataproc and Google BigQuery APIs
...
#### 5.1.e. Artifact Registry Reader for UMSA

```
gcloud projects add-iam-policy-binding $PROJECT_ID \
    --member serviceAccount:$UMSA@$PROJECT_ID.iam.gserviceaccount.com --role roles/artifactregistry.reader
