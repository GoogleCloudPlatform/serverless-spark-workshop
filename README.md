...
| 8 | [Telco Anomaly Detection (with Dataproc UI Instructions)](cell-tower-anomaly-detection/README.md) | Data Engineering | Serverless Spark Batch from CLI with Cloud Composer orchestration, Dataproc UI instructions, and the Persistent History Server (for viewing completed and running Spark jobs) | [TEKsystems](https://www.teksystems.com/en/about-us/partnerships/google-cloud) |
...
| 24 | [Spark dataframe analysis on Vertex Generative AI](https://github.com/velascoluis/genai_experiments) | GenAI | Integrated LLMs text generation capablities with Apache Spark, powered by Vertex AI on Google Cloud | [Luis Velasco](https://github.com/velascoluis) |
