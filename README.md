...
| 13 | [Telco Anomaly Detection (with row level security)](https://github.com/velascoluis/telco-demo) | Data Engineering | Identifying defective cell towers for maintenance: using Terraform to deploy GCP components, using BigLake to create GCS external tables in PARQUET and CSV files formats and to unify row access policies from BigQuery and Serverless Spark | [Luis Velasco](https://github.com/velascoluis) |
